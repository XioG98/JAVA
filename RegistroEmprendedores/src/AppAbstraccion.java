...
public class AppPolimorfismo {
    public static void main(String[] args) {
        ...
        //Crear instancias de los participantes, personas
        Persona emprendedor = new Emprendedor("Laura", "1223", "Tech disruptivas", "Envigado");
        Persona mentor = new Mentor("Carlos", "456", "Fintech", "Medellin", "Innovacion Financiera");
        Persona evaluador = new Evaluador("Brayan", "789", "TechDev", "Cali");

        //Crear instancia de registroServicio

        RegistroServicio servicio = new RegistroServicio();

        //Polimorfismo estático: Usando métodos sobrecargados
        System.out.println("\n:::::::::REGISTRO INDIVIDUAL::::::::::");
        servicio.registrar(emprendedor);
        servicio.registrar(mentor, true);
        servicio.registrar("Registro VIP", evaluador);

        //Polimorfismo estático + dinamico con arreglo
        System.out.println("::::::::::::::REGISTRO MULTIPLE:::::::::::::");
        Persona[] participantes = {emprendedor, mentor, evaluador};
        servicio.registrar(participantes);
    }
        /*
